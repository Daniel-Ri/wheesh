...
import com.daniel.wheesh.orderedseat.ResponseDataOrderedSeat;
...
@AllArgsConstructor
@NoArgsConstructor
public class ResponseDataOrderWithOrderedSeatDetails {
    private Long id;
    private Long userId;
    ...
    private List<ResponseDataOrderedSeat> orderedSeats;
}
