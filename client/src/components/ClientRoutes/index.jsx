...
const ClientRoutes = () => {
  const getRoutes = () => {
    ...
    const renderElement = (route) => {
      const { layout: Layout, component: Component, protected: Protected, allowedRoles } = route;
      ...
      return Protected ? <Client allowedRoles={allowedRoles}>{element}</Client> : element;
    };
